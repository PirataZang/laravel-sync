<template>
    <div class="grid-wrapper ag-theme-quartz">
        <AgGridVue class="grid" theme="legacy" :rowData="rowData" :columnDefs="columnDefs" :defaultColDef="defaultColDef" :localeText="localeText" pagination :paginationAutoPageSize="true" :rowSelection="rowSelection" @grid-ready="onGridReady" @selection-changed="onSelectionChanged" />
    </div>
</template>
